...
void rutafinal(int siz, int *matr, int in, int out, int mintemp, int *maxm, int *recMin, int rec[]){ //Este método se utiliza para evaluar los recorridos de 1 tramo, o el último tramo del recorrido
